export const theme = {
  ...
  budgetProgressTrack: 'var(--color-budgetProgressTrack)',
  budgetProgressFilled: 'var(--color-budgetProgressFilled)',
  budgetProgressPartial: 'var(--color-budgetProgressPartial)',
  budgetProgressOverspent: 'var(--color-budgetProgressOverspent)',
  budgetProgressPace: 'var(--color-budgetProgressPace)',
